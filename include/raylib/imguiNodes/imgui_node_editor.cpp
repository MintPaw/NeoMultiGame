...
ed::EditorAction::AcceptResult ed::NavigateAction::Accept(const Control& control)
{
    ...
    {
        // const auto zoomMode = io.KeyShift ? NavigateAction::ZoomMode::WithMargin : NavigateAction::ZoomMode::None; //@ShiftCtrlHack
        const auto zoomMode = NavigateAction::ZoomMode::None;
...
ed::EditorAction::AcceptResult ed::SelectAction::Accept(const Control& control)
{
    ...
    auto& io = ImGui::GetIO();
    m_SelectGroups   = /*io.KeyShift*/ false; //@ShiftCtrlHack
