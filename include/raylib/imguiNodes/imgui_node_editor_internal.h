...
static inline float& ImFringeScaleRefStatic(ImDrawList* drawList)
{
...
struct FringeScaleScope
{
    ...
    FringeScaleScope(float scale)
        : m_LastFringeScale(ImFringeScaleRefStatic(ImGui::GetWindowDrawList()))
    {
        ImFringeScaleRefStatic(ImGui::GetWindowDrawList()) = scale;
    }

    ~FringeScaleScope()
    {
        ImFringeScaleRefStatic(ImGui::GetWindowDrawList()) = m_LastFringeScale;
    }
